...
public class UrlFunctionsTest {
  ...
  public void testNestedRefinementAdditionWithMapping() throws JspException, UrlBeautifier.UrlBeautificationException {
    ...
    String url = UrlFunctions.toUrlAdd(DEFAULT_BEAUTIFIER, "", new ArrayList<Navigation>(), "product.title", new RefinementValue().setValue("Civil War")
        .setCount(87));
  ...
  public void testRefinementAdditionWithMapping() throws JspException, UrlBeautifier.UrlBeautificationException {
    ...
    navigations.add(new Navigation().setName("gender")
                        ...
                        .setRange(false)
                        .setRefinements(singletonList(new RefinementValue().setValue("Women"))));

    navigations.add(new Navigation().setName("simpleColorDesc")
                        .setDisplayName("Color")
                        .setRange(false)
                        .setRefinements(singletonList(new RefinementValue().setValue("Pink"))));

    String url = UrlFunctions.toUrlAdd(DEFAULT_BEAUTIFIER, "", navigations, "product", new RefinementValue().setValue("Clothing")
        .setCount(87));
  ...
  public void testRefinementAdditionWithMappingMulti() throws JspException, UrlBeautifier.UrlBeautificationException {
    ...
    String url = UrlFunctions.toUrlAdd(DEFAULT_BEAUTIFIER, "", navigations, "gender", new RefinementValue().setValue("Men")
        .setCount(87));
    assertEquals("/Women/Men/Pink/ggc/index.html", url);

    url = UrlFunctions.toUrlAdd(DEFAULT_BEAUTIFIER, "", navigations, "gender", new RefinementValue().setValue("Kid")
        .setCount(874));
  ...
  public void testRefinementAdditionWithoutMappingAndSpace() throws JspException {
    ...
    String url = UrlFunctions.toUrlAdd(DEFAULT_BEAUTIFIER, "", navigations, "product", new RefinementValue().setValue("Clothing Box")
        .setCount(87));
