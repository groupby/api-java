...
public class UrlFunctions {
  ...
  public static String toUrlAdd(
      String identifier, String searchString, List<Navigation> navigations, String navigationName, Refinement refinement) throws JspException {
  ...
  public static String toUrlRemove(
      String identifier, String searchString, List<Navigation> navigations, String navigationName, Refinement refinement) throws JspException {
    UrlBeautifier urlBeautifier = getBeautifier(identifier);
